...
@PETERCORDBOT.on(admin_cmd(pattern="sin ?(.*)"))
@PETERCORDBOT.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@PETERCORDBOT.on(admin_cmd(pattern="cos ?(.*)"))
@PETERCORDBOT.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@PETERCORDBOT.on(admin_cmd(pattern="tan ?(.*)"))
@PETERCORDBOT.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@PETERCORDBOT.on(admin_cmd(pattern="cosec ?(.*)"))
@PETERCORDBOT.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@PETERCORDBOT.on(admin_cmd(pattern="sec ?(.*)"))
@PETERCORDBOT.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@PETERCORDBOT.on(admin_cmd(pattern="cot ?(.*)"))
@PETERCORDBOT.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@PETERCORDBOT.on(admin_cmd(pattern="square ?(.*)"))
@PETERCORDBOT.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@PETERCORDBOT.on(admin_cmd(pattern="cube ?(.*)"))
@PETERCORDBOT.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
