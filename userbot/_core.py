...
@PETERCORDBOT.on(admin_cmd(pattern=r"send (?P<shortname>\w+)", outgoing=True))
@PETERCORDBOT.on(sudo_cmd(pattern=r"send (?P<shortname>\w+)", allow_sudo=True))
...
@PETERCORDBOT.on(admin_cmd(pattern="install$", outgoing=True))
@PETERCORDBOT.on(sudo_cmd(pattern="install$", allow_sudo=True))
...
@PETERCORDBOT.on(admin_cmd(pattern=r"uninstall (?P<shortname>\w+)", outgoing=True))
@PETERCORDBOT.on(sudo_cmd(pattern=r"uninstall (?P<shortname>\w+)", allow_sudo=True))
...
@PETERCORDBOT.on(admin_cmd(pattern=r"unload (?P<shortname>\w+)$"))
@PETERCORDBOT.on(sudo_cmd(pattern=r"upload (?P<shortname>\w+)$", allow_sudo=True))
...
@PETERCORDBOT.on(admin_cmd(pattern=r"load (?P<shortname>\w+)$"))
@PETERCORDBOT.on(sudo_cmd(pattern=r"load (?P<shortname>\w+)$", allow_sudo=True))
